...
const translations = {
  es: {
    ...
    'home.xpKicker': 'Progreso',
    'home.xpTitle': 'Nivel',
    'home.xpNext': 'Siguiente',
    'home.xpClasses': 'clases',
    'home.of': 'de',
    'home.recommendedKicker': 'Recomendado',
    'home.recommendedTitle': 'Clase del día',
    'home.recommendedAction': 'Practicar',
    'home.continueKicker': 'Aprendizaje',
    'home.continueTitle': 'Continuar aprendiendo',
    'home.continueAction': 'Ir',
    'home.continueEmpty': '¡Has completado todas las clases!',
    'home.weeklyKicker': 'Actividad',
    'home.weeklyTitle': 'Progreso semanal',
    'home.weeklyEmpty': 'Sin actividad esta semana',
    'home.achievementsKicker': 'Logros',
    'home.achievementsTitle': 'Insignias',
    'home.achievementsEmpty': 'Completa clases para desbloquear logros',
    'home.quizHistoryKicker': 'Historial',
    'home.quizHistoryTitle': 'Últimos quizzes',
    'home.quizHistoryEmpty': 'Sin quizzes realizados aún',
    ...
    'classes.availableCategories': 'Categorías del catálogo',
    'classes.catalogTerms': 'Términos del catálogo',
    ...
    'classes.startQuiz': 'Comenzar Quiz',
    'classes.quizError': 'Error al enviar quiz',
    'classes.yourAnswer': 'tu respuesta',
    'classes.correct': 'correcto',
    'classes.mcqHint': 'Elige la traducción correcta para cada término',
    'classes.mcqOptionA': 'A',
    'classes.mcqOptionB': 'B',
    'classes.mcqOptionC': 'C',
    'classes.mcqOptionD': 'D',
    'classes.mcqSelect': 'Selecciona una opción',
    'classes.mcqCorrect': '¡Correcto!',
    'classes.mcqIncorrect': 'Incorrecto',
    'classes.mcqExplanation': 'Explicación',
    'classes.mcqDefinition': 'Definición',
    'classes.mcqTerm': 'Término',
    'classes.mcqYourAnswer': 'Tu respuesta',
    'classes.mcqExpected': 'Respuesta correcta',
    ...
    'dashboard.paidAccountsEmpty': 'Todavía no hay pagos confirmados.',
    'dashboard.paidAccountsLocalHint': 'Conecta Google Sheets para ver los pagos confirmados.',
    ...
    'profile.quizHistoryKicker': 'Historial',
    ...
    'profile.miniClasses': 'Clases',
    'profile.miniQuizzes': 'Quizzes',
    'profile.miniScore': 'Puntos',
    'profile.actionsKicker': 'Acciones',
    'profile.actionsTitle': 'Cuenta',
    'profile.customizeKicker': 'Personalizar',
    'profile.customizeTitle': 'Apariencia',
    'profile.avatarColor': 'Color de avatar',
    'profile.avatarPhoto': 'Foto de perfil',
    'profile.uploadPhoto': 'Subir foto',
    'profile.removePhoto': 'Quitar foto',
    'profile.photoHint': 'JPG, PNG o WebP. Máx 200x200px.',
    'profile.photoSaved': 'Foto de perfil actualizada',
    'profile.photoRemoved': 'Foto de perfil eliminada',
    'profile.photoInvalidType': 'Formato de imagen no válido',
    'profile.photoTooLarge': 'La imagen es demasiado grande (máx 5MB)',
    'profile.bioKicker': 'Sobre ti',

    'profile.bioTitle': 'Biografía',
    'profile.bioLabel': 'Descripción breve',
    'profile.bioSaved': 'Biografía guardada',
    'profile.saveBio': 'Guardar biografía',
    'profile.preferencesKicker': 'Preferencias',
    'profile.preferencesTitle': 'Aprendizaje',
    'profile.preferredVoice': 'Voz de pronunciación',
    'profile.preferredTheme': 'Tema visual',
    ...
    'profile.statsKicker': 'Estadísticas',
    'profile.statsTitle': 'Rendimiento',
    'profile.statAccuracy': 'Precisión',
    'profile.statStreak': 'Racha (días)',
    'profile.statTotalQuizzes': 'Quizzes totales',
    'profile.statPassed': 'Aprobados',
    'profile.levelProgressKicker': 'Niveles',
    'profile.levelProgressTitle': 'Progreso por nivel',
    'profile.achievementsKicker': 'Logros',
    'profile.achievementsTitle': 'Insignias',
  ...
  en: {
    ...
    'home.xpKicker': 'Progress',
    'home.xpTitle': 'Level',
    'home.xpNext': 'Next',
    'home.xpClasses': 'classes',
    'home.of': 'of',
    'home.recommendedKicker': 'Recommended',
    'home.recommendedTitle': 'Class of the day',
    'home.recommendedAction': 'Practice',
    'home.continueKicker': 'Learning',
    'home.continueTitle': 'Continue learning',
    'home.continueAction': 'Go',
    'home.continueEmpty': 'You have completed all classes!',
    'home.weeklyKicker': 'Activity',
    'home.weeklyTitle': 'Weekly progress',
    'home.weeklyEmpty': 'No activity this week',
    'home.achievementsKicker': 'Achievements',
    'home.achievementsTitle': 'Badges',
    'home.achievementsEmpty': 'Complete classes to unlock achievements',
    'home.quizHistoryKicker': 'History',
    'home.quizHistoryTitle': 'Last quizzes',
    'home.quizHistoryEmpty': 'No quizzes taken yet',
    ...
    'classes.availableCategories': 'Catalog categories',
    'classes.catalogTerms': 'Catalog terms',
    ...
    'classes.mcqHint': 'Choose the correct translation for each term',
    'classes.mcqOptionA': 'A',
    'classes.mcqOptionB': 'B',
    'classes.mcqOptionC': 'C',
    'classes.mcqOptionD': 'D',
    'classes.mcqSelect': 'Select an option',
    'classes.mcqCorrect': 'Correct!',
    'classes.mcqIncorrect': 'Incorrect',
    'classes.mcqExplanation': 'Explanation',
    'classes.mcqDefinition': 'Definition',
    'classes.mcqTerm': 'Term',
    'classes.mcqYourAnswer': 'Your answer',
    'classes.mcqExpected': 'Correct answer',
    ...
    'profile.quizHistoryKicker': 'History',
    ...
    'profile.miniClasses': 'Classes',
    'profile.miniQuizzes': 'Quizzes',
    'profile.miniScore': 'Points',
    'profile.actionsKicker': 'Actions',
    'profile.actionsTitle': 'Account',
    'profile.customizeKicker': 'Customize',
    'profile.customizeTitle': 'Appearance',
    'profile.avatarColor': 'Avatar color',
    'profile.avatarPhoto': 'Profile photo',
    'profile.uploadPhoto': 'Upload photo',
    'profile.removePhoto': 'Remove photo',
    'profile.photoHint': 'JPG, PNG or WebP. Max 200x200px.',
    'profile.photoSaved': 'Profile photo updated',
    'profile.photoRemoved': 'Profile photo removed',
    'profile.photoInvalidType': 'Invalid image format',
    'profile.photoTooLarge': 'Image is too large (max 5MB)',
    'profile.bioKicker': 'About you',

    'profile.bioTitle': 'Biography',
    'profile.bioLabel': 'Short description',
    'profile.bioSaved': 'Biography saved',
    'profile.saveBio': 'Save biography',
    'profile.preferencesKicker': 'Preferences',
    'profile.preferencesTitle': 'Learning',
    'profile.preferredVoice': 'Pronunciation voice',
    'profile.preferredTheme': 'Visual theme',
    'profile.savePreferences': 'Save preferences',
    'profile.preferencesSaved': 'Preferences saved',
    'profile.preferencesError': 'Error saving preferences',
    'profile.statsKicker': 'Statistics',
    'profile.statsTitle': 'Performance',
    'profile.statAccuracy': 'Accuracy',
    'profile.statStreak': 'Streak (days)',
    'profile.statTotalQuizzes': 'Total quizzes',
    'profile.statPassed': 'Passed',
    'profile.levelProgressKicker': 'Levels',
    'profile.levelProgressTitle': 'Level progress',
    'profile.achievementsKicker': 'Achievements',
    'profile.achievementsTitle': 'Badges',
...
const classTitleVariants = [
  ...
  { es: 'Historia y Evolución del Fútbol', en: 'History and Evolution of Football' },
  { es: 'Reglas Detalladas del Juego', en: 'Detailed Rules of the Game' },
  { es: 'Grandes Jugadores y Leyendas', en: 'Great Players and Legends' },
  { es: 'Competiciones y Torneos', en: 'Competitions and Tournaments' },
  { es: 'Equipamiento y Vestimenta Deportiva', en: 'Equipment and Sportswear' },
  { es: 'Aficionados y Cultura del Fútbol', en: 'Fans and Football Culture' },
];
...
const classCategoryVariants = [
  ...
  { es: 'Reglas', en: 'Rules' },
  { es: 'Leyendas', en: 'Legends' },
  { es: 'Competiciones', en: 'Competitions' },
  { es: 'Equipamiento', en: 'Equipment' },
