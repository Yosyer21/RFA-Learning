...
const translations = {
  es: {
    ...
    'classes.suggestionsTitle': 'Repaso recomendado',
    'classes.suggestionsSubtitle': 'Clases donde necesitas más práctica',
    'classes.suggestionsEmpty': '¡Buen trabajo! No tienes términos pendientes de repasar.',
    'classes.suggestionsMistakes': '{0} errores',
    'classes.suggestionsReview': 'Repasar',
    'classes.flashcardsTitle': 'Flashcards',
    'classes.flashcardsSubtitle': 'Estudia con tarjetas de memoria',
    'classes.flashcardsStart': 'Iniciar flashcards',
    'classes.flashcardsFlip': 'Voltear tarjeta',
    'classes.flashcardsPrev': 'Anterior',
    'classes.flashcardsNext': 'Siguiente',
    'classes.flashcardsKnown': 'La sé',
    'classes.flashcardsUnknown': 'No la sé',
    'classes.flashcardsDone': '¡Completaste las flashcards!',
    'classes.flashcardsCard': 'Tarjeta {0} de {1}',
    'classes.writingTitle': 'Práctica de escritura',
    'classes.writingSubtitle': 'Escribe la traducción en inglés',
    'classes.writingStart': 'Iniciar escritura',
    'classes.writingPlaceholder': 'Escribe la traducción en inglés...',
    'classes.writingCheck': 'Comprobar',
    'classes.writingCorrect': '¡Correcto!',
    'classes.writingIncorrect': 'Incorrecto. La respuesta era: {0}',
    'classes.writingDone': '¡Completaste la práctica de escritura!',
    'classes.writingScore': 'Puntuación: {0}/{1}',
    'classes.progressLabel': 'Dominio',
    'classes.progressMastered': 'Dominado',
    'classes.progressInProgress': 'En progreso',
    'classes.progressNotStarted': 'Sin empezar',
    'classes.progressPercent': '{0}% dominado',
    'classes.studyMode': 'Estudiar',
    'classes.flashcardsMode': 'Flashcards',
    'classes.writingMode': 'Escritura',
    'classes.quizMode': 'Quiz',
    'classes.modeLabel': 'Modo de práctica',
    ...
    'classrooms.kicker': 'Aulas',
    'classrooms.title': 'Mis aulas',
    'classrooms.subtitle': 'Gestiona tus aulas y estudiantes.',
    'classrooms.newClassroom': 'Nueva aula',
    'classrooms.namePlaceholder': 'Nombre del aula',
    'classrooms.descriptionPlaceholder': 'Descripción (opcional)',
    'classrooms.createClassroom': 'Crear aula',
    'classrooms.invitationsTitle': 'Invitaciones pendientes',
    'classrooms.invitationsEmpty': 'No tienes invitaciones pendientes.',
    'classrooms.myClassrooms': 'Mis aulas',
    'classrooms.classroomsEmpty': 'Aún no tienes aulas.',
    'classrooms.empty': 'Aún no tienes aulas.',
    'classrooms.emptyStudent': 'Aún no estás en ninguna aula.',
    'classrooms.members': 'miembros',
    'classrooms.teacher': 'Profesor',
    'classrooms.inviteBtn': 'Invitar',
    'classrooms.noInvitations': 'No tienes invitaciones pendientes.',
    'classrooms.accept': 'Aceptar',
    'classrooms.decline': 'Rechazar',
    'classrooms.accepted': 'Invitación aceptada',
    'classrooms.declined': 'Invitación rechazada',
    'classrooms.inviteTitle': 'Invitar estudiante',
    'classrooms.searchPlaceholder': 'Buscar estudiante por nombre o correo...',
    'classrooms.noStudents': 'No se encontraron estudiantes.',
    'classrooms.invited': 'Invitado',
    'classrooms.noMembers': 'Aún no hay miembros.',
    'classrooms.membersTitle': 'Miembros',
    'classrooms.remove': 'Quitar',
    'classrooms.removed': 'Miembro eliminado',
    'classrooms.created': 'Aula creada',
    'classrooms.listTitle': 'Mis aulas',
    'classrooms.listTitleStudent': 'Mis aulas',

    // Classroom (vista detallada)
    'classroom.back': '← Volver a aulas',
    'classroom.kicker': 'Aula',
    'classroom.members': 'miembros',
    'classroom.joinMeeting': 'Unirse a reunión',
    'classroom.meetingTitle': 'Reunión del aula',
    'meeting.kicker': 'Videollamada',
    'meeting.join': 'Unirse a la reunión',
    'meeting.create': 'Crear reunión',
    'meeting.cancel': 'Cancelar',
    'meeting.hint': 'Se abrirá Jitsi Meet en esta página. Asegúrate de permitir el acceso a cámara y micrófono.',
    'meeting.leave': 'Salir de la reunión',
    'meeting.teacher': 'Profesor',
    'meeting.student': 'Estudiante',
    'classroom.teacher': 'Profesor',
    'classroom.postKicker': 'Publicar',
    'classroom.newPost': 'Publicar algo en el aula',
    'classroom.postPlaceholder': 'Escribe un anuncio o mensaje para el aula...',
    'classroom.publish': 'Publicar',
    'classroom.assignmentKicker': 'Tarea',
    'classroom.newAssignment': 'Crear tarea',
    'classroom.assignmentTitlePlaceholder': 'Título de la tarea',
    'classroom.assignmentDescPlaceholder': 'Descripción de la tarea (opcional)',
    'classroom.dueDate': 'Fecha de entrega',
    'classroom.createAssignment': 'Crear tarea',
    'classroom.wallKicker': 'Muro',
    'classroom.wall': 'Publicaciones',
    'classroom.noPosts': 'Aún no hay publicaciones.',
    'classroom.assignmentsKicker': 'Tareas',
    'classroom.assignments': 'Tareas',
    'classroom.noAssignments': 'Aún no hay tareas.',
    'classroom.submitted': 'Entregada',
    'classroom.pending': 'Pendiente',
    'classroom.viewSubmissions': 'Ver entregas',
    'classroom.editSubmission': 'Editar entrega',
    'classroom.submit': 'Entregar',
    'classroom.created': 'Creada',
    'classroom.submissionPlaceholder': 'Escribe tu respuesta o entrega aquí...',
    'classroom.submissionRequired': 'Escribe una respuesta antes de entregar.',
    'classroom.noSubmissions': 'Aún no hay entregas.',
    'classroom.published': 'Publicación creada',
    'classroom.assignmentCreated': 'Tarea creada',
    'classroom.comments': 'Comentarios',
    'classroom.comment': 'Comentar',
    'classroom.commentPlaceholder': 'Escribe un comentario...',
    'classroom.noComments': 'Aún no hay comentarios.',
    'classroom.loading': 'Cargando...',
    'classroom.grade': 'Calificación',
    'classroom.gradePlaceholder': 'Calificación (0-100)',
    'classroom.feedbackPlaceholder': 'Retroalimentación',
    'classroom.saveGrade': 'Guardar',
    'classroom.gradeSaved': 'Calificación guardada',
    'classroom.membersKicker': 'Miembros',
    'classroom.noMembers': 'Aún no hay miembros.',
    'classroom.online': 'En línea',
    'classroom.offline': 'Desconectado',
    'classroom.meetingsKicker': 'Reuniones',
    'classroom.meetingHistory': 'Historial de reuniones',
    'classroom.noMeetings': 'Aún no hay reuniones.',
    'classroom.calendarKicker': 'Calendario',
    'classroom.calendar': 'Próximas entregas',
    'classroom.noCalendar': 'No hay entregas próximas.',
    'classroom.shareMeeting': 'Compartir enlace',
    'classroom.linkCopied': 'Enlace de reunión copiado',
    'classroom.attachFile': 'Adjuntar archivo',
    // Teacher home (panel del profesor)

    'teacher.kicker': 'Panel del profesor',

    'teacher.subtitle': 'Gestiona tus aulas y acompaña a tus estudiantes.',
    'teacher.newClassroom': 'Nueva aula',
    'teacher.viewClasses': 'Ver clases',
    'teacher.statClassrooms': 'Aulas',
    'teacher.statMembers': 'Estudiantes',
    'teacher.statClasses': 'Clases',
    'teacher.statProfile': 'Perfil',
    'teacher.progressKicker': 'Progreso',
    'teacher.progressTitle': 'Mis aulas',
    'teacher.progressNext': 'Crea aulas para empezar',
    'teacher.progressClasses': 'aulas',
    'teacher.progressMembers': 'estudiantes',
    'teacher.classroomsKicker': 'Aulas',
    'teacher.classroomsTitle': 'Mis aulas',
    'teacher.namePlaceholder': 'Nombre del aula',
    'teacher.descriptionPlaceholder': 'Descripción (opcional)',
    'teacher.createClassroom': 'Crear aula',
    'teacher.classroomsEmpty': 'Aún no tienes aulas. Crea la primera para empezar.',
    'teacher.quickKicker': 'Accesos',
    'teacher.quickTitle': 'Accesos rápidos',
    'teacher.quickNewClassroom': 'Crea un aula y comparte su código',
    'teacher.quickClasses': 'Explora el contenido de fútbol',
    'teacher.quickProfile': 'Edita tu información y preferencias',
    'teacher.code': 'Código',
    'teacher.members': 'miembros',
    'teacher.classroomCreated': 'Aula creada',
  ...
  en: {
    ...
    'classes.suggestionsTitle': 'Recommended review',
    'classes.suggestionsSubtitle': 'Classes where you need more practice',
    'classes.suggestionsEmpty': 'Great job! You have no terms pending review.',
    'classes.suggestionsMistakes': '{0} mistakes',
    'classes.suggestionsReview': 'Review',
    'classes.flashcardsTitle': 'Flashcards',
    'classes.flashcardsSubtitle': 'Study with memory cards',
    'classes.flashcardsStart': 'Start flashcards',
    'classes.flashcardsFlip': 'Flip card',
    'classes.flashcardsPrev': 'Previous',
    'classes.flashcardsNext': 'Next',
    'classes.flashcardsKnown': 'I know it',
    'classes.flashcardsUnknown': "I don't know it",
    'classes.flashcardsDone': 'You completed the flashcards!',
    'classes.flashcardsCard': 'Card {0} of {1}',
    'classes.writingTitle': 'Writing practice',
    'classes.writingSubtitle': 'Write the English translation',
    'classes.writingStart': 'Start writing',
    'classes.writingPlaceholder': 'Write the English translation...',
    'classes.writingCheck': 'Check',
    'classes.writingCorrect': 'Correct!',
    'classes.writingIncorrect': 'Incorrect. The answer was: {0}',
    'classes.writingDone': 'You completed the writing practice!',
    'classes.writingScore': 'Score: {0}/{1}',
    'classes.progressLabel': 'Mastery',
    'classes.progressMastered': 'Mastered',
    'classes.progressInProgress': 'In progress',
    'classes.progressNotStarted': 'Not started',
    'classes.progressPercent': '{0}% mastered',
    'classes.studyMode': 'Study',
    'classes.flashcardsMode': 'Flashcards',
    'classes.writingMode': 'Writing',
    'classes.quizMode': 'Quiz',
    'classes.modeLabel': 'Practice mode',
    ...
    // Classrooms (lista de aulas)
    'classrooms.kicker': 'Classrooms',
    'classrooms.title': 'My classrooms',
    'classrooms.subtitle': 'Manage your classrooms and students.',
    'classrooms.newClassroom': 'New classroom',
    'classrooms.namePlaceholder': 'Classroom name',
    'classrooms.descriptionPlaceholder': 'Description (optional)',
    'classrooms.createClassroom': 'Create classroom',
    'classrooms.invitationsTitle': 'Pending invitations',
    'classrooms.invitationsEmpty': 'You have no pending invitations.',
    'classrooms.myClassrooms': 'My classrooms',
    'classrooms.classroomsEmpty': 'You have no classrooms yet.',
    'classrooms.empty': 'You have no classrooms yet.',
    'classrooms.emptyStudent': 'You are not in any classroom yet.',
    'classrooms.members': 'members',
    'classrooms.teacher': 'Teacher',
    'classrooms.inviteBtn': 'Invite',
    'classrooms.noInvitations': 'You have no pending invitations.',
    'classrooms.accept': 'Accept',
    'classrooms.decline': 'Decline',
    'classrooms.accepted': 'Invitation accepted',
    'classrooms.declined': 'Invitation declined',
    'classrooms.inviteTitle': 'Invite student',
    'classrooms.searchPlaceholder': 'Search student by name or email...',
    'classrooms.noStudents': 'No students found.',
    'classrooms.invited': 'Invited',
    'classrooms.noMembers': 'No members yet.',
    'classrooms.membersTitle': 'Members',
    'classrooms.remove': 'Remove',
    'classrooms.removed': 'Member removed',
    'classrooms.created': 'Classroom created',
    'classrooms.listTitle': 'My classrooms',
    'classrooms.listTitleStudent': 'My classrooms',

    // Classroom (vista detallada)
    'classroom.back': '← Back to classrooms',
    'classroom.kicker': 'Classroom',
    'classroom.members': 'members',
    'classroom.joinMeeting': 'Join meeting',
    'classroom.meetingTitle': 'Classroom meeting',
    'meeting.kicker': 'Video call',
    'meeting.join': 'Join the meeting',
    'meeting.create': 'Create meeting',
    'meeting.cancel': 'Cancel',
    'meeting.hint': 'Jitsi Meet will open on this page. Make sure to allow camera and microphone access.',
    'meeting.leave': 'Leave the meeting',
    'meeting.teacher': 'Teacher',
    'meeting.student': 'Student',
    'classroom.teacher': 'Teacher',
    'classroom.postKicker': 'Post',
    'classroom.newPost': 'Post something to the classroom',
    'classroom.postPlaceholder': 'Write an announcement or message for the classroom...',
    'classroom.publish': 'Post',
    'classroom.assignmentKicker': 'Assignment',
    'classroom.newAssignment': 'Create assignment',
    'classroom.assignmentTitlePlaceholder': 'Assignment title',
    'classroom.assignmentDescPlaceholder': 'Assignment description (optional)',
    'classroom.dueDate': 'Due date',
    'classroom.createAssignment': 'Create assignment',
    'classroom.wallKicker': 'Wall',
    'classroom.wall': 'Posts',
    'classroom.noPosts': 'No posts yet.',
    'classroom.assignmentsKicker': 'Assignments',
    'classroom.assignments': 'Assignments',
    'classroom.noAssignments': 'No assignments yet.',
    'classroom.submitted': 'Submitted',
    'classroom.pending': 'Pending',
    'classroom.viewSubmissions': 'View submissions',
    'classroom.editSubmission': 'Edit submission',
    'classroom.submit': 'Submit',
    'classroom.created': 'Created',
    'classroom.submissionPlaceholder': 'Write your answer or submission here...',
    'classroom.submissionRequired': 'Write an answer before submitting.',
    'classroom.noSubmissions': 'No submissions yet.',
    'classroom.published': 'Post created',
    'classroom.assignmentCreated': 'Assignment created',
    'classroom.comments': 'Comments',
    'classroom.comment': 'Comment',
    'classroom.commentPlaceholder': 'Write a comment...',
    'classroom.noComments': 'No comments yet.',
    'classroom.loading': 'Loading...',
    'classroom.grade': 'Grade',
    'classroom.gradePlaceholder': 'Grade (0-100)',
    'classroom.feedbackPlaceholder': 'Feedback',
    'classroom.saveGrade': 'Save',
    'classroom.gradeSaved': 'Grade saved',
    'classroom.membersKicker': 'Members',
    'classroom.noMembers': 'No members yet.',
    'classroom.online': 'Online',
    'classroom.offline': 'Offline',
    'classroom.meetingsKicker': 'Meetings',
    'classroom.meetingHistory': 'Meeting history',
    'classroom.noMeetings': 'No meetings yet.',
    'classroom.calendarKicker': 'Calendar',
    'classroom.calendar': 'Upcoming deadlines',
    'classroom.noCalendar': 'No upcoming deadlines.',
    'classroom.shareMeeting': 'Share link',
    'classroom.linkCopied': 'Meeting link copied',
    'classroom.attachFile': 'Attach file',
    // Teacher home (panel del profesor)
    'teacher.kicker': 'Teacher panel',

    'teacher.subtitle': 'Manage your classrooms and support your students.',
    'teacher.newClassroom': 'New classroom',
    'teacher.viewClasses': 'View classes',
    'teacher.statClassrooms': 'Classrooms',
    'teacher.statMembers': 'Students',
    'teacher.statClasses': 'Classes',
    'teacher.statProfile': 'Profile',
    'teacher.progressKicker': 'Progress',
    'teacher.progressTitle': 'My classrooms',
    'teacher.progressNext': 'Create classrooms to get started',
    'teacher.progressClasses': 'classrooms',
    'teacher.progressMembers': 'students',
    'teacher.classroomsKicker': 'Classrooms',
    'teacher.classroomsTitle': 'My classrooms',
    'teacher.namePlaceholder': 'Classroom name',
    'teacher.descriptionPlaceholder': 'Description (optional)',
    'teacher.createClassroom': 'Create classroom',
    'teacher.classroomsEmpty': 'You have no classrooms yet. Create the first one to get started.',
    'teacher.quickKicker': 'Shortcuts',
    'teacher.quickTitle': 'Quick access',
    'teacher.quickNewClassroom': 'Create a classroom and share its code',
    'teacher.quickClasses': 'Explore football content',
    'teacher.quickProfile': 'Edit your information and preferences',
    'teacher.code': 'Code',
    'teacher.members': 'members',
    'teacher.classroomCreated': 'Classroom created',
